...
export function MenuLateral({
  ...
  const accesos: { id: string; href: string; texto: string; icono: ReactNode; mostrar: boolean }[] = [
    ...
    // "Disponibilidad" va pegada a Consultorios y Profesionales: las tres son la administración
    // del espacio, y esta contesta la pregunta que llega de afuera ("¿tenés lugar?").
    { id: "disponibilidad", href: `${raiz}/disponibilidad`, texto: "Disponibilidad", icono: <IconoHueco />, mostrar: puede(rol, "sala.administrar") },
